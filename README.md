...
| **Séance 3** | **Data Mining & A/B Testing** <br> *Analyses factorielles, Tests stat & Prédiction* | [📑 cours_3.html](https://oliviercaron.github.io/web_data_mining_webi/cours_3/cours_3.html) | **Exploration** : [ACP & ACM (FactoMineR)](http://factominer.free.fr/index_fr.html) <br> **Inférence** : [Comprendre la p-value](https://www.youtube.com/watch?v=vemZtEM63GY) · [Guide des A/B tests](https://vwo.com/ab-testing/) <br> **Modélisation** : [Arbres de décision](https://explained.ai/decision-tree-viz/) · [Régression Logistique](https://christophebenoit.org/cours-regression-logistique/) |
| **Séance 4** | **Données Géographiques (GIS)** <br> *Cartographie & analyse spatiale* | [📑 cours_4.html](https://oliviercaron.github.io/web_data_mining_webi/cours_4/cours_4.html) | **Packages R** : [sf](https://r-spatial.github.io/sf/) · [leaflet](https://rstudio.github.io/leaflet/) · [tmap](https://r-tmap.github.io/tmap/) <br> **Guides R spatial** : [R-Spatial (Engel)](https://cengel.github.io/R-spatial/) · [Geocomputation with R](https://r.geocompx.org/) · [Spatial Data Science (Moraga)](https://www.paulamoraga.com/book-spatial/) <br> **Analyses avancées** : [Spatial Analysis in R (Paez)](https://paezha.github.io/spatial-analysis-r/) · [GDS Applications (Duke)](https://ryan-lab-duke.github.io/gds-applications-site/intro.html) · [Spatial Data Analysis & Visualization](https://github.com/rajikudusadewale/Spatial-Data-Analysis) |
| **Séance 5** | **Analyse de Réseaux (SNA)** <br> *Graphes sociaux et communautés* | *(À venir)* | **R** : [igraph](https://r.igraph.org/) · [ggraph](https://ggraph.data-imaginist.com/) · [tidygraph](https://tidygraph.data-imaginist.com/) <br> **Réseaux & SNA** : [R4SNA](https://schochastics.github.io/R4SNA/) · [awesome-network-analysis](https://github.com/briatte/awesome-network-analysis) · [Analyse de réseau en SHS](https://beauguitte.github.io/analyse-de-reseau-en-shs/) <br> **Références en ligne** : [Network Atlas](https://www.networkatlas.eu/index.htm) · [Network Science](https://networksciencebook.com/) · [Networks Textbook](https://olizardo.github.io/networks-textbook/) · [ONA Book](https://ona-book.org/index.html) · [Structural Virality (bookdown)](https://bookdown.org/mike/marketing_research/structural-virality.html) |
