...
| **Séance 5** | **Analyse de Réseaux (SNA)** <br> *Graphes sociaux et communautés* | *(À venir)* | **R** : [igraph](https://r.igraph.org/) · [ggraph](https://ggraph.data-imaginist.com/) · [tidygraph](https://tidygraph.data-imaginist.com/) <br> **Réseaux & SNA** : [R4SNA](https://schochastics.github.io/R4SNA/) · [awesome-network-analysis](https://github.com/briatte/awesome-network-analysis) · [Analyse de réseau en SHS](https://beauguitte.github.io/analyse-de-reseau-en-shs/) <br> **Références en ligne** : [Network Atlas](https://www.networkatlas.eu/index.htm) · [Network Science](https://networksciencebook.com/) · [Networks Textbook](https://olizardo.github.io/networks-textbook/) · [ONA Book](https://ona-book.org/index.html) · [Structural Virality (bookdown)](https://bookdown.org/mike/marketing_research/structural-virality.htm) |
